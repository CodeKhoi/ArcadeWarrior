 ...
 let gameMenu = new Phaser.Scene('Menu')
 let config = {
    type: Phaser.AUTO,
    width: 800,
    height: 600,
    ...
    gameMenu.preload = function () {
        this.load.image('bg', '/img/kartBG.jpg');
        this.load.image('koomba', '/img/KoombaMain.png')
        this.load.image('mario', '/img/mariotraffic.png')
        this.load.image('playbtn', '/img/playbutton.png')

    }

    gameMenu.create = function () {
        let background = this.add.sprite(450, 300, 'bg');
        this.add.image(650, 400, 'koomba')
        this.add.image(300, 200, 'mario')
        this.startBtn = this.add.sprite(300, 350, 'playbtn').setInteractive()

    }

    gameMenu.update = function() {
   ...
   gameScene.init = function() {
    ...
    gameScene.preload = function()
    {
        ...
        this.load.image('lose', '/img/loseMessage.jpg')
    ...
    // player walks
        ...
        // shake the camera
            ...
            this.add.image(400, 350, 'lose');
          }, [], this);

            this.time.delayedCall(10000, function() {
            this.cameras.main.fade(10000);
          }, [], this);
